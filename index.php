...
<header class="header__container">
    ...
    <div class="header__content">
        ...
        <p>
            Start Your Ride Today and Explore the City <br> - Your Adventure Awaits with Convenient Journeys, Memorable
            Stops, and Endless Possibilities!
        </p>
        <div class="container">
    ...
    <div class="row clearfix" id="testimoniesSection">
        ...
        <div class="testcon">
            ...
            <blockquote class="col-3 testimonial classic john">
                ...
                <q>This auto rickshaw booking app is fantastic! It’s super easy to use, and the drivers are always
                    punctual. Highly recommend it for anyone needing a quick ride around town!</q>
            ...
            <blockquote class="col-3 testimonial classic user2">
                ...
                <q>I’ve tried several rickshaw apps, but this one stands out. The interface is clean, and the booking
                    process is seamless. Plus, the drivers are friendly and reliable.</q>
            ...
            <blockquote class="col-3 testimonial classic user3">
                ...
                <q>Great app with a user-friendly design! I love how quickly I can book a ride and track my rickshaw in
                    real-time. It’s made my daily commute so much smoother.</q>
